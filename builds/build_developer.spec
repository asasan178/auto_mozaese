...
exe = EXE(
    ...
    strip=False,  # Retain debug information for developers
    upx=False,    # UPX compression disabled for stability  
    console=True, # Developer version shows console for debugging
    icon='../icon.ico',
    optimize=0,   # No optimization to retain debug symbols
