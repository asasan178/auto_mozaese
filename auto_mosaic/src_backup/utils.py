"""
Utility functions and type helpers for 自動ヨフモザ v1.0
...
class 自動モザエセLogger:
    ...
    def _setup_logger(self):
        ...
        file_handler = logging.FileHandler(log_dir / "auto_mosaic.log", encoding='utf-8')
...
def create_desktop_shortcut():
    """
    Create desktop shortcut for 自動ヨフモザ (Windows only)
    """
    try:
        import winshell
        ...
        path = os.path.join(desktop, "自動ヨフモザ.lnk")
        ...
        shortcut.Description = "自動ヨフモザ v1.0 - アニメ・イラスト画像のモザイク処理ツール"
        shortcut.save()
